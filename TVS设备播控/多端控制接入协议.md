...
|    jsonBlobInfo         |    string   |    是      |    具体的业务请求数据(反序列化成Json格式，对应多端控制各个接口的请求数据)    |

**说明：DMSDK已经封装了对应的header和payload参数，开发者只需要填写对应的domain，intent，jsonBlobInfo参数值即可**
...
|    Parameter                    |    Type        |    必选    |    描述                                    |
|    :--------------------------- |    :--------  |    :-----    |    :-----------------------------------    |
|    jsonBlobInfo                 |    string    |    是    |    具体的业务数据(反序列化成Json格式，对应多端控制各个接口的返回数据)    |

**说明：DMSDK已经封装了对应的payload参数，开发者只需要填写对应的jsonBlobInfo参数值即可**
